...
_C.MODEL.THRESH = 0.0
_C.MODEL.IF_USE_PCB = False
_C.MODEL.MERGE_PCB_FEAT = True
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
_C.TEST.EVAL = False
# K1, K2, LAMBDA
_C.TEST.RE_RANKING_PARAMETER = [30, 2, 0.8]
_C.TEST.USE_LOCAL = True
# if this config set False,will use 6 pcb feature for test.
# if this config set True ,will just use pcb last conv out for test.
_C.TEST.PCB_GLOBAL_FEAT_ENSEMBLE = False
_C.TEST.USE_PCB_MERGE_FEAT = True
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
