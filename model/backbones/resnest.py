...
class ResNest(nn.Module):
    ...
    def __init__(self, last_stride, block, layers, radix=1, groups=1, bottleneck_width=64,
                 ...
                 last_gamma=False, norm_layer=nn.BatchNorm2d, with_ibn=False, frozen_stages=-1):
        self.cardinality = groups
...
def resnest50_ibn(last_stride, pretrained=False, root='~/.encoding/models', **kwargs):
    model = ResNest(last_stride, Bottleneck, [3, 4, 6, 3],
...
def resnest101_ibn(last_stride, pretrained=False, root='~/.encoding/models', **kwargs):
    model = ResNest(last_stride, Bottleneck, [3, 4, 23, 3],
                   radix=2, groups=1, bottleneck_width=64,
...
def resnest50(last_stride, pretrained=False, root='~/.encoding/models', **kwargs):
    model = ResNest(last_stride, Bottleneck, [3, 4, 6, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=32, avg_down=True,
...
def resnest101(last_stride, pretrained=False, root='~/.encoding/models', **kwargs):
    model = ResNest(last_stride, Bottleneck, [3, 4, 23, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=64, avg_down=True,
                   avd=True, avd_first=False, **kwargs)
...
def resnest200(last_stride, pretrained=False, root='~/.encoding/models', **kwargs):
    model = ResNest(last_stride, Bottleneck, [3, 24, 36, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=64, avg_down=True,
                   avd=True, avd_first=False, **kwargs)
    if pretrained:
...
def resnest269(last_stride, pretrained=False, root='~/.encoding/models', **kwargs):
    model = ResNest(last_stride, Bottleneck, [3, 30, 48, 8],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=64, avg_down=True,
                   avd=True, avd_first=False, **kwargs)
    if pretrained:
